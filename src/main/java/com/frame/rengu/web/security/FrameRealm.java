...
* @Package com.frame.rengu.web.security
...
import com.frame.rengu.service.IPermissionService;
...
public class FrameRealm  extends AuthorizingRealm{
	...
	@Autowired
	private FrameRetryLimitHashedCredentialsMatcher credentialsMatcher;
