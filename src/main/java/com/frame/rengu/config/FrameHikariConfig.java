...
@MapperScan(basePackages="com.frame.rengu.data.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
...
//        sessionFactory.setTypeAliasesPackage( "com.frame.rengu.data.po" );
