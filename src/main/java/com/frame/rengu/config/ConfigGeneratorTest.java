...
public class ConfigGeneratorTest {
    protected static ConfigGenerator getConfigGenerator() {
        ...
        cg.setEntityPackage("com.frame.rengu.data.po");//entity 实体包路径

        cg.setMapperPackage("com.frame.rengu.data.mapper");//mapper 映射文件路径

        cg.setServicePackage("com.frame.rengu.data.service");//service 层路径
